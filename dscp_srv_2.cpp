...
public:
    ...
    point select_method(/*nbvplanner::dcsp_srv::Request &req, nbvplanner::dcsp_srv::Request &res*/);
        ...
        for (it = my_domain.begin(); it != my_domain.end(); ++it){
            ...
            if (is_new_value_consistent) {
                ...
                for (it3 = lower_priority_agents.begin(); it3 != lower_priority_agents.end(); ++it3){
                    ...
                    /*
                     ROS SERVICE CALL TO THE CORRESPONDING FIREFLY DCSP SERVICE with OK flag
...
Agent::point Agent::select_method(/*nbvplanner::dcsp_srv::Request &req, nbvplanner::dcsp_srv::Request &res*/){
